...
class AppColor {
  ...
  static const Color secondaryColor = Color(0xffB1F6FF);
  static const Color warningColor = Color(0xffFFA23A);
  static const Color errorColor = Color(0xffFE5050);
  static const Color successColor = Color(0xff38C976);
  static const Color brownColor = Color(0xff4E2022);

  // Ligth Mode
  static const Color bgLight = Color(0xffF6F6FB);
  static const Color cardLight = Color(0xffFFFFFF);
  static const Color lightText1 = Color(0xff1A1717);
...
// Dark Mode
  ...
  static const Color darkText2 = Color(0xff90A3BF);
